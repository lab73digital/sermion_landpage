...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    function e(a, c) {
        if (!a)return [0, 0];
        a = b(a), c = c || d(a) + 1;
        var e = g(a), f = e.strokeDasharray || "", h = parseFloat(e.strokeDashoffset), i = f.indexOf(",");
